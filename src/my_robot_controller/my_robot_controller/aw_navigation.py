...
class CarNavigationNode(Node):
    ...
    def __init__(self):
       ...
       ############# [Initial Location] ############
        ...
        initial_pose.pose.pose.position.x = 3749.15
        initial_pose.pose.pose.position.y = 73771.16
       ...
       # Initialize goal poses as dictionaries {x, y, w}
        ...
        self.goal_poses.append({'x': 3818.45, 'y': 73791.875, 'xx': 0.0, 'yy': 0.0,'zz': 0.85,'w': 0.52})
        self.goal_poses.append({'x': 3769.69, 'y': 73698.16, 'xx': 0.0, 'yy': 0.0,'zz': 0.22,'w': 0.97})
        self.goal_poses.append({'x': 3717.72, 'y': 73741.21, 'xx': 0.0, 'yy': 0.0,'zz': 0.23,'w': 0.97})
